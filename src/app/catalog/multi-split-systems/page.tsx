...
import MultiSplitSystems from '@/components/MultiSplitSystems/MultiSplitSystems';
...
export default async function HomeSplitPage({ searchParams }: { searchParams: { page?: string } }) {
  ...
  return <MultiSplitSystems products={products} currentPage={currentPage} totalPages={totalPages} />;
}
