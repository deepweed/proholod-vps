...
import RefrigerationEquipment from '@/components/RefrigerationEquipment/RefrigerationEquipment';
...
export default async function HomeSplitPage({ searchParams }: { searchParams: { page?: string } }) {
  ...
  return <RefrigerationEquipment products={products} currentPage={currentPage} totalPages={totalPages} />;
}
