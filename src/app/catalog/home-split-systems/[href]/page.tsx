...
export const generateMetadata = ({ params }: Props): Metadata => {
  ...
  return {
    ...
    description: `Бытовой кондеционер ${params.href} – отличное техническое решение для создания комфортного микроклимата в помещениях небольшой площади.`,
    openGraph: {
      title: `Сплит-система - ${trueTitle}`,
      description: `Бытовой кондеционер ${params.href} – отличное техническое решение для создания комфортного микроклимата в помещениях небольшой площади.`,
    }
      ...
      <section className="mb-8">
            <Breadcrumb>
                <BreadcrumbList>
                    ...
                    <BreadcrumbItem>
                        <BreadcrumbLink asChild>
                            <Link href="/catalog/home-split-systems">Бытовые сплит-системы</Link>
                        </BreadcrumbLink>
                    </BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb>
        ...
        <section className="mb-3">
          ...
          {product.stats && product.stats.length > 0 ? (
            <div className="w-full bg-gray-100 p-4 rounded-md shadow-md">
              ...
              {product.stats[0].coolingKw != null && (
              <div className="mb-2">
                <div className="flex justify-between items-center mb-2">
              ...
              {product.stats[0].warmingKw != null && (
              <div className="mb-2">
                <div className="flex justify-between items-center mb-2">
