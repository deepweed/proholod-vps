...
export const generateMetadata = ({ params }: Props): Metadata => {
  const trueTitle = params.href.split(" ").join(" ").toString().toUpperCase();

  return {
    title: `Сплит-система ${trueTitle}`,
    description: `Сплит-система ${params.href} – высокоэффективное и надежное решение для создания оптимального микроклимата в офисных и коммерческих помещениях, обеспечивая комфорт и продуктивность в любых условиях.`,
    openGraph: {
      title: `Сплит-система - ${trueTitle}`,
      description: `Сплит-система ${params.href} – высокоэффективное и надежное решение для создания оптимального микроклимата в офисных и коммерческих помещениях, обеспечивая комфорт и продуктивность в любых условиях.`,
    }
      ...
      <section className="mb-5">
            <Breadcrumb>
                <BreadcrumbList>
                    ...
                    <BreadcrumbItem>
                        <BreadcrumbLink asChild>
                            <Link href="/catalog/inverter-commercial">Инверторные коммерческие сплит-системы</Link>
                        </BreadcrumbLink>
                    </BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb>
        ...
        <section className="mb-3">
          ...
          {product.stats && product.stats.length > 0 ? (
            <div className="w-full bg-gray-100 p-4 rounded-md shadow-md">
              ...
              <div className="mb-2">
                <p className="font-semibold text-sm">Блок внутренний</p>
              </div>
              ...
              <div className="mb-2">
                <p className="font-semibold text-sm">Блок наружный</p>
              </div>
              )}
              {product.stats[0].widthBlock != null && (
              <div className="mb-2">
