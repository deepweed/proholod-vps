...
import InverterSplit from '@/components/InverterCommercial/InverterCommercial';
...
export default async function HomeSplitPage({ searchParams }: { searchParams: { page?: string } }) {
  ...
  return <InverterSplit products={products} currentPage={currentPage} totalPages={totalPages} />;
}
