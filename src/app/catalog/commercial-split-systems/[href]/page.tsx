...
export const generateMetadata = ({ params }: Props): Metadata => {
  ...
  return {
    ...
    description: `Сплит-система ${trueTitle} – высокоэффективное и надежное решение для создания оптимального микроклимата в офисных и коммерческих помещениях, обеспечивая комфорт и продуктивность в любых условиях.`,
    openGraph: {
      title: `Сплит-система - ${trueTitle}`,
      description: `Сплит-система ${trueTitle} – высокоэффективное и надежное решение для создания оптимального микроклимата в офисных и коммерческих помещениях, обеспечивая комфорт и продуктивность в любых условиях.`,
    }
      ...
      <section className="mb-5">
            <Breadcrumb>
                <BreadcrumbList>
                    ...
                    <BreadcrumbItem>
                        <BreadcrumbLink asChild>
                            <Link href="/catalog/commercial-split-systems">Коммерческие сплит-системы</Link>
                        </BreadcrumbLink>
                    </BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb>
