...
const FirstService = () => {
    ...
    const handleFormSubmit = async () => {
        ...
        const formData = {
            title: "первое_гарантийное_обслуживание",
            name: name,
            phone: phone,
            model: model,
            date: date,
    ...
    return (
        <>
            <h1 className="text-xl font-bold mb-10">Первое гарантийное обслуживание</h1>
            <div className="block lg:flex">
                <div className="w-full block lg:w-1/2">
                    <p className="mb-4 w-full lg:w-[530px]">
                        Пожалуйста, заполните форму ниже, чтобы запросить первое гарантийное обслуживание. Перед отправкой заявки, пожалуйста, ознакомьтесь с условиями гарантийного обслуживания.
                        <br /><br />
                ...
                <div>
                    <h2 className="text-sm font-bold mb-4">Что из себя представляет первое гарантийное обслуживание?</h2>
