...
const ThirdService = () => {
    ...
    const handleFormSubmit = async () => {
        ...
        const formData = {
            title: "третье_гарантийное_обслуживание",
            name: name,
            phone: phone,
            model: model,
            date: date,
    ...
    return (
        <>
            <h1 className="text-xl font-bold mb-10">Третье гарантийное обслуживание</h1>
            <div className="block lg:flex lg:justify-between">
                <div className="w-full block lg:w-1/2">
                    <p className="mb-4 w-full lg:w-[530px]">
                        Пожалуйста, заполните форму ниже, чтобы запросить третье гарантийное обслуживание. Перед отправкой заявки, пожалуйста, ознакомьтесь с условиями гарантийного обслуживания.
                        <br /><br />
                    ...
                    <Button className="w-full mb-5 lg:w-[500px] h-[45px]" variant="blue" onClick={handleFormSubmit}>
                        Запросить третье гарантийное обслуживание
                    </Button>
                ...
                <div>
                    <h2 className="text-sm font-bold mb-4">Что из себя представляет третье гарантийное обслуживание?</h2>
