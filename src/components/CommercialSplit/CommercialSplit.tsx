...
const CommercialSplit = ({ products, currentPage, totalPages }: CommercialSplitProps) => {
  return (
    <>
      ...
      <section className="mb-4">
        <h2 className="text-2xl font-semibold mb-2">Коммерческие сплит-системы</h2>
            ...
            {products.map((product) => (
              <li key={product.id}>
                <ProductCard 
                  ...
                  link={`/catalog/commercial-split-systems/${product.href}`}
...
export default CommercialSplit;
