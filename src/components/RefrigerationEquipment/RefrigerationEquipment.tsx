...
interface RefrigerationEquipmentProps {
  products: Product[];
  currentPage: number;
  totalPages: number;
}
...
const RefrigerationEquipment = ({ products, currentPage, totalPages }: RefrigerationEquipmentProps) => {
  return (
    <>
      ...
      <section className="mb-4">
        <h2 className="text-2xl font-semibold mb-2">Холодильное оборудование</h2>
            ...
            {products.map((product) => (
                <li key={product.id}>
                  <ProductCard 
                    ...
                    link={`/catalog/refrigeration-equipment/${product.href}`}
...
export default RefrigerationEquipment;
