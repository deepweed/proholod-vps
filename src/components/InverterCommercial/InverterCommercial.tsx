...
interface InverterSplitProps {
  products: Product[];
  currentPage: number;
  totalPages: number;
}

const InverterSplit = ({ products, currentPage, totalPages }: InverterSplitProps) => {
  return (
    <>
      ...
      <section className="mb-4">
        <h2 className="text-2xl font-semibold mb-2">Инверторные коммерческие сплит-системы</h2>
            ...
            {products.map((product) => (
              <li key={product.id}>
                <ProductCard 
                  ...
                  link={`/catalog/inverter-commercial/${product.href}`}
